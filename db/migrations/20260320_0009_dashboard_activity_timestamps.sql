-- Align dashboard "last activity" signals to content timestamps instead of permission sync timestamps.
-- Share-related sync observations remain available through last_share_dt/last_shared_at fields.
